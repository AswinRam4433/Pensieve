...
class CLIPImageSearcher:
    """A comprehensive CLIP-based image search system with persistent storage."""
    ...
    def __init__(self, image_dir: str = "images", model_name: str = "ViT-B/32",
        ...
        # Search parameters
        self.similarity_threshold = 0.1  # Minimum similarity for results
        self.batch_size = 32  # Batch size for processing images
    ...
    def find_duplicate_images(self, index: faiss.Index, metadata: Dict, 
        ...
        for i, embedding in enumerate(embeddings):
            ...
            similarities, indices = index.search(query, len(embeddings))
            
            # Find highly similar images
            similar_images = []
            for j, idx in enumerate(indices[0]):
